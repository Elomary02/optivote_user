...
class HomePageFragment : Fragment() {
    ...
    fun proceedToVote() {
        ...
        if (codeEnteredByUser != null) {
            ...
            voteRecordViewModel.checkUserDecisionLiveDate.observe(viewLifecycleOwner){
                    voteCheck->
                if (voteCheck != null) {
                    if (voteCheck.isEmpty()) {
                        ...
                        Log.d("vote Check","Already Voted")
                }
                }


            }
            voteRecordViewModel.checkUserDecision(codeEnteredByUser, UserInInfo.id)
